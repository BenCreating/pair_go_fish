class TurnResult
  attr_reader :turn_player, :asked_player, :taken_cards, :fished_card, :asked_card

  def initialize(turn_player, asked_player, asked_card:, taken_cards: [], fished_card: false, completed_set: false)
